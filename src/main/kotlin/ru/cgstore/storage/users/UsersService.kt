...
interface UsersService {
    ...
    suspend fun read(id: String): Either<Failure, User>
    ...
    suspend fun read(): Either<Failure, List<User>>
    suspend fun update(): Either<Failure, Unit>
    suspend fun setRole(): Either<Failure, Unit>
